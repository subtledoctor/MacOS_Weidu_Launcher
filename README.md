...
<div class="section">
  ...
  <p>Before doing a batch install, you can feel free to move things around in MWL.TXT, or delete lines or even add lines - just make sure added lines follow the same format of "~this_mod/this_mod.tp2~ #1 #1" where the first number is your chosen language <b>for that mod</b> (be careful, this can differ from one mod to another!) and the second number is the component of that mod you want to install.</p>
